<?php
require_once 'EjemploPDO.php';


class EjemploClaseSistema extends EjemploPDO {

	//acá los atributos de las tablas
	private  $columArt = array('ID'=>'ID', 'Name'=>'Name', 'Year'=>'Year', 'IDArtista'=>'IDArtista');
	
	public $columFiltros = array('ID'=>'ID', 'Name'=>'Name', 'Year'=>'Year', 'IDArtista'=>'IDArtista');
	
	public function mostrar($start='0', $limit='0', $sort = "", $dir = "ASC"){
  	
		global $filtros;
		 
		$query = "SELECT * FROM ilustraciones ".$this->filtrarQuery($filtros);			
