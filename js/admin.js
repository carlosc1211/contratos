...
function datoscontrato(){
	...
	if(Ext.getCmp("co_filiall").getValue()!='')co_ubicacion=Ext.getCmp("co_filiall").getValue();
	if(Ext.getCmp("co_direccionn").getValue()!='')co_ubicacion=Ext.getCmp("co_direccionn").getValue();
	if(Ext.getCmp("co_divisionn").getValue()!='')co_ubicacion=Ext.getCmp("co_divisionn").getValue();
	if(Ext.getCmp("co_distritoo").getValue()!='')co_ubicacion=Ext.getCmp("co_distritoo").getValue();
	...
	datos = '{"co_filial" : "'+Ext.getCmp("co_filiall").getValue()+'", ';
	datos += '"co_ubicacion" : "'+co_ubicacion+'", ';
	datos += '"co_direccion" : "'+Ext.getCmp("co_direccionn").getValue()+'", ';
	datos += '"co_division" : "'+Ext.getCmp("co_divisionn").getValue()+'", ';
	datos += '"co_distrito" : "'+Ext.getCmp("co_distritoo").getValue()+'", ';
	datos += '"co_organizacion" : "'+Ext.getCmp("co_organizacion_adnim").getValue()+'", ';
...
function validacion_guardar(){
	var valido=1;
	/*if(Ext.getCmp("co_filiall").getValue()!='')
		co_ubicacion=Ext.getCmp("co_filiall").getValue();
	if(Ext.getCmp("co_direccionn").getValue()!='')
		co_ubicacion=Ext.getCmp("co_direccionn").getValue();
	if(Ext.getCmp("co_divisionn").getValue()!='')
		co_ubicacion=Ext.getCmp("co_divisionn").getValue();
	if(Ext.getCmp("co_distritoo").getValue()!='')
		co_ubicacion=Ext.getCmp("co_distritoo").getValue();
	if (co_ubicacion==0)
		valido=0;*/
     ...
     items: [{
		...
		items: [{
			...
			items: [GetComboUbicacion('co_filial','Filial o Negocio',1,'co_direccionn','co_organizacion_adnim',true)]
					...
					columnWidth: .5,
					layout: 'form',	
			items: [GetComboUbicacion('co_direccionn','Direcci&oacute;n',2,'co_divisionn','co_organizacion_adnim')] 
				},{
					columnWidth: .5,
					layout: 'form',
			items: [GetComboUbicacion('co_divisionn','Divisi&oacute;n',3,'co_distritoo','co_organizacion_adnim')]
				},{
					columnWidth: .5,
					layout: 'form',
			items: [GetComboUbicacion('co_distritoo','Distrito',4,'co_organizacion_adnim')]  
				},{
					columnWidth: .5,
					layout: 'form',
			items: [GetComboDinamico('co_organizacion_adnim','co_organizacion','Organizaci&oacute;n','organizacion_ubicacion',false,'local')]
				},]
	},{
		  xtype:'fieldset',
					...
					Ext.MessageBox.confirm("[CONTRATOS]","Seguro que Deseas Guardar?", function(btn)
				 {
					 if(btn == 'yes')
					 {
						...
						if(validacion_guardar()==1){
							...
							WinError("Debe completar los datos obligatorio para Guardar");
						}
...
Ext.getCmp('co_filial').on('select', function(combo,record,index){
		Ext.getCmp('co_direccionn').clearValue();
		Ext.getCmp('co_divisionn').clearValue();
		Ext.getCmp('co_distritoo').clearValue();
		Ext.getCmp('co_organizacion_adnim').clearValue();
		Ext.getCmp('co_direccionn').store.reload({params:{ubicacion:record.data.co_ubicacion}});
		Ext.getCmp('co_direccionn').enable();
