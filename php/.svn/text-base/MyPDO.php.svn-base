...
class MyPDO extends PDO {
   ...
   /*** Attributes: ***/
	...
	include("../config/conf.php");
	 if ($pdo==NULL){
		...
		try {
			...
			echo 'Conexion Fallida: <br/> Ha ocurrido un error al intentar establecer conexion con el servidor. Por favor contacte con el administrador o custodio de esta aplicacin para notificarle acerca de este error. ';  //. $e->getMessage();
			exit;
		}
	...
	public function _insertLastId($tabla, $atributos){
		//echo $atributos);
		$comillas = "";
	    $columnas = array_keys($atributos);
		$insert = "INSERT INTO ".$tabla." (";
